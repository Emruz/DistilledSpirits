...
#receiver = ['shahin@pirooz.net','jpapier@wrpwealth.com','lpolanowski@yahoo.com','sjsantandrea@gmail.com','scott@stephenson.cc']
...
baseurl = "https://m.klwines.com/Products/?&filters=sv2_dflt-stock-instock!28$eq$(3)$True$ff-28-(3)--$or,27.or,48!90$eq$1$True$ff-90-1--$&limit=50&offset=0&orderBy=60%20asc,search.score()%20desc&searchText="
baseurl = "https://m.klwines.com/Products?&filters=sv2_NewProductFeedYN$eq$1$True$ProductFeed$!dflt-stock-instock!28$eq$(3)$True$ff-28-(3)--$or,27.or,48!90$eq$1$True$ff-90-1--$&limit=50&offset=0&orderBy=60%20asc,NewProductFeedDate%20desc&searchText="
