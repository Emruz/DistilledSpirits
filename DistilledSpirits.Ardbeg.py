...
url = "https://m.klwines.com/Products?&filters=sv2_dflt-stock-instock!30$eq$(216)$True$ff-30-(216)--$!28$eq$(3)$True$ff-28-(3)--$or,27.or,48&orderBy=60%20asc,search.score()%20desc&searchText=Ardbeg"
...
subject = "Shaq's Distilled Ardbeg List - {}".format(startTime.strftime("%b %d, %Y %I:%M %p"))
